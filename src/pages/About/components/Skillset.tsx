    ...
    useEffect(() => {
        function handleScroll() {
            if (
                ...
                activeTech &&
                Math.abs(
                    activeTech?.scrollAtClick - sectionRef.current.scrollTop
                ) > 350
            ) {
                setActiveTech(null);
            }
                            ...
                            <motion.li
                                ...
                                onClick={() => {
                                    if (activeTech?.label !== tech.label) {
                                        setActiveTech({
                                            label: tech.label,
                                            scrollAtClick: sectionRef.current!
                                                .scrollTop,
                                        });
                                    }
                                }}
                                ...
                                data-in-view={techsInView ? "true" : "false"}
                            >
                                <motion.img
                                    layout
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <motion.span
                                            layout
                                            className={styles.proficiencyValue}
                                        >
                                            {tech.proficiency}
                                        </motion.span>
                                    </motion.p>
                                        ...
                                        {activeTech?.label === tech.label ? (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    elit. Ullam laboriosam illum
                                                    minima dolore reprehenderit
                                                    eveniet quas quos odit
                                                    maiores ducimus. Harum
                                                    labore sint fuga consequatur
                                                    consequuntur dolore,
                                                    laboriosam animi
                                                    repudiandae?
                                                </motion.p>
